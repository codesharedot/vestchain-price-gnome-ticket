#!/usr/bin/env python
# rename to fnb-protocol.1r.60s.py and put in ~.config/argos
import re
...
def coin():
    data = requests.get("https://api.coinmarketcap.com/v1/ticker/fnb-protocol/")
...
print("fnb-protocol $" + str(usd) + " | iconName=invest-applet")
print("---")
